...
if __name__ == "__main__":
    ...
    parser_group.add_argument('-s', metavar='Filename', action="store", help="Send directly to TVheadend via defined Socket path. Example: /some/path/socketname.sock", dest="s")
