...
if __name__ == "__main__":
    ...
    parser.add_argument('-t', metavar='Time in hours', type=int, help="Enter how many hours of epg to load. USE WITH CAUTION! Excessive use may leads to API ban!!! Default: 26", nargs='?', const=26, default=26, dest="t")
